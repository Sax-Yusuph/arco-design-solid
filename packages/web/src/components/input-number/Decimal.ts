...
export class BigIntDecimal implements Decimal {
  ...
  private readonly integer: bigint = BigInt('1')

  private readonly decimal: bigint = BigInt('1')

  private readonly decimalLen: number = 0
