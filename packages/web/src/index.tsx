...
export type { BackTopProps } from './components/backTop/interface';
...
export type { VerificationCodeProps } from './components/verification-code/interface';
...
export type {
	CountdownProps, StatisticHandle, StatisticProps
} from './components/statistic/interface';

export { default as Steps } from './components/steps';
export type { StepProps, StepsProps } from './components/steps/interface';
