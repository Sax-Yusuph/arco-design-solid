...
export type InputTriggers = 'onBlur' | 'onPressEnter'
/**
 * @title Input
 * @zh **Input 接受所有原生的属性值**
...
export interface InputProps
  extends Omit<
    ...
    'onInput' | 'prefix' | 'size' | 'height' | 'maxLength'
  > {
  /**
   * @zh 允许清空输入框
   ...
   * @version 2.54.0
   */
  autoWidth?: boolean | Pick<JSX.CSSProperties, 'min-width' | 'max-width'>
   ...
   * @defaultValue ['onBlur']
   */
  normalizeTrigger?: InputTriggers[]
  /**
...
export interface TextAreaProps
  extends Omit<JSX.TextareaHTMLAttributes<HTMLTextAreaElement>, 'onInput' | 'maxLength'> {
  /**
...
export interface InputSearchProps extends InputProps {
   ...
   * @zh 搜索按钮
   * @en Search button
   * @version `JSXElement` in 2.6.0
   */
  searchButton?: boolean | JSXElement
}
